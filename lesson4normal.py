...
print(f"Имя '{name}' введено", re.match('[А-Я]', name) is not None)
print(f"Фамилия '{surname}' введено", re.match('[А-Я]', surname) is not None)

email = input("Введите электронную почту: ")
pattern = "^[a-z0-9_\.]+@[a-z0-9]+\.+[ru|org|com]+"

print(f"Почта {email} введена", re.search(pattern, email) is not None)
...
pattern = "\.{2,}"
print(f"В стихотворении встречается подряд более одной точки?", re.search(pattern, poem) is not None)
